...
const { login, logout, register, updateUser, verifyEmail, currentUser, deleteAccount, forgotPassword, verifyOTP, sendOTP, findAccoundSendOTP } = require("../controllers/auth.controller.js")
